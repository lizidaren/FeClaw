...
| **02-curio.md** | `docs/v1/02-curio.md` | 📝 本篇 | Curio（格物所）完整设计。主页/时间线/注意到/画布/拍照入库/搜索/数据模型/Pipeline。 |
...
| **v1.0.0** | **2026-07-10** | **首次有统一版本的产品级发布。Curio + Universe 以独立产品形态出现。完整产品哲学与设计原则。** |
...
- minor 版本对应功能发布（如 Curio 画布上线 → v1.1.0）
- patch 对应小修小补
